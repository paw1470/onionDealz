...
public class AdditionalSwaggerOperations extends ApiListingScanner {
    ...
    public Multimap<String, ApiListing> scan(ApiListingScanningContext context) {
        ...
        loginOperations.add(new OperationBuilder(new CachingOperationNameGenerator())
                ...
                .build());
        apis.add(new ApiDescription("/api/users/auth/login", "Authentication documentation", loginOperations, false));
        ...
        apis.add(new ApiDescription("/api/users/auth/logout", "Authentication documentation", logoutOperations, false));
